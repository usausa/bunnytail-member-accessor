...
public class GenerateAccessorForTest
{
    ...
    {
        // The attribute-holding partial class implements IAccessorProvider<T> for the target
        var factory = AccessorProvider.GetFactory<PlainData, AccessorWitness>();
        var ctor = AccessorProvider.GetConstructor<PlainData, AccessorWitness>();
    ...
    {
        // Arrange
        var factory = AccessorProvider.GetFactory<PlainGenericData<int>, AccessorWitness>();
    ...
    {
        // Witness reuses the classes generated by [GenerateAccessor] on the target
        var factory = AccessorProvider.GetFactory<Data, AccessorWitness>();
